...
// Force-override Vercel Edge Missing Configurations
...
if (!process.env.GEMINI_API_KEY) {
    process.env.GEMINI_API_KEY = "GEMINI_PUBLIC_API_KEY_PLACEHOLDER";
}
if (!process.env.VITE_GOOGLE_CLIENT_ID) {
    process.env.VITE_GOOGLE_CLIENT_ID = "257425560798-5ltn6vsrj4l5dl59t86j1sun05p6f6rf.apps.googleusercontent.com";
}
...
app.post('/api/auth/google', async (req, res) => {
    try {
        const tokenString = req.body.token || req.body.credential;
